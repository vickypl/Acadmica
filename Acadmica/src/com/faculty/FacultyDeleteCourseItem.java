...
public class FacultyDeleteCourseItem extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(contentType.equals("filetype")) {
			...
			if(isRecordOfFileCleared) {
				...
				response.sendRedirect("facultycoursefilesview.jsp?msg=File Deleted");
			} else {
				response.sendRedirect("facultycoursefilesview.jsp?msg=Failed to delete the file.");				
			}
		...
		if(contentType.equals("videotype")) {
			...
			if(isRecordOfFileCleared) {
				...
				response.sendRedirect("facultycoursevideosview.jsp?msg=Video Deleted");
			} else {
				response.sendRedirect("facultycoursevideosview.jsp?msg=Failed to delete the video.");				
			}
		}
