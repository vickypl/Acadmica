...
public class AdminEditStudent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("deaneditstudentdetail.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(updateStatus) {
			response.sendRedirect("adminstudentfulldetail?studentid="+regid);
		} else {
			response.sendRedirect("admineditstudent?id="+regid+"&?msg=Student Updated failed..");
		}
