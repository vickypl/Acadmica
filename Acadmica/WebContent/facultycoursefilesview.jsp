...
<table class="table" style="color: white;">
  ...
  int count=1; for(CourseFiles cf : courseFileList) {%>
    <tr>
    	...
    	<td align="left"><a href="facultydeletecourseitem?id=<%=cf.getId() %>&type=filetype&url=<%=cf.getUrl()%>&cid=<%=cf.getCourseId()%>"><button class="btn btn-danger">Delete</button></a></td>
    </tr>
    <tr>
